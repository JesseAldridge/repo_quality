...
repo_lists = collections.OrderedDict([
  ...
  ('content_management_systems', [
    ...
    "arterli/CmsWing",
    "AsgardCms/Platform",
    "Awesome-CMS-Core/Awesome-CMS-Core",
    "backdrop/backdrop",
    "bolt/bolt",
    "BootstrapCMS/CMS",
    "Canner/canner",
    ...
    "modxcms/revolution",
    "mrsinguyen/awesome-drupal",
    "netlify/netlify-cms",
    "notadd/notadd",
    "octobercms/october",
    "odirleiborgert/borgert-cms",
    "opps/opps",
    "OrchardCMS/Orchard",
    ...
    "refinerycms-contrib/awesome-refinerycms",
    "relax/relax",
    "roadiz/roadiz",
    "rochacbruno/quokka",
    "sanityi / sanity",
    ...
    "XOOPS/XoopsCore",
    "xujeff/tianti",
    "yii2sarter-kit / yii2-starter-kit",
  ]),
  ('data_processing', [
  ...
  ('natural_language_processing', [
    "1991viet/Hierarchical-attention-networks-pytorch",
    "aboSamoor/polyglot",
    "AdrienGuille/TOM",
